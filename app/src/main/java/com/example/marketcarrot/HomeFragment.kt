...
class HomeFragment : Fragment() {
    ...
    lateinit var mLastLocation: DescriptorProtos.SourceCodeInfo.Location // 위치 값을 가지고 있는 객체
    ...
    private val mLocationCallback = object : LocationCallback() {
        override fun onLocationResult(locationResult: LocationResult) {
            ...
            locationX = "위도 : " + locationResult.lastLocation.latitude // 갱신 된 위도
            locationY = "경도 : " + locationResult.lastLocation.longitude // 갱신 된 경도
            Log.i("myLocation", "${locationX}\n${locationY}")
        }
    }
...
//        locationX = "위도 : " + mLastLocation.latitude // 갱신 된 위도
//        locationY = "경도 : " + mLastLocation.longitude // 갱신 된 경도
//        Log.i("myLocation", "${locationX}\n${locationY}")
//    }
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        if (requestCode == REQUEST_PERMISSION_LOCATION) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(requireActivity(), "권한이 없어 해당 기능을 실행할 수 없습니다.", Toast.LENGTH_SHORT).show()
            }
        }
    }
